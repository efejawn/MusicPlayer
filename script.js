...
// SONG LIBRARY
let songFull = ['Thousand Miles', 'Talk To You', 'Hearts', 'Paper Planes', 'Atlantis', 'Sway To My Beat In Cosmos', 'Divine', 'Hope Is the Thing With Feathers', 'LOVE or HATE?', 'Pompeii', 'Invasion - Metal Version', 'Divide My Heart', 'The Lazy Song', 'Final Battle', 'SequÊncia MalÉfica 1.0', 'Bolinha De Queijo', 'Automotivo InsÔnia 1.0 - Slowed + Reverb', 'Me Papa Que É Pop', 'Ive never forgotten', 'OneRepublic', 'Paradox', 'Paradisus-Paradoxum', 'Id rather sleep']
let songID = []
...
let singerName = [`the Kid LAROI`, 'Zach B', 'Zach B', 'M.I.A.', 'Seafret', 'Chevy', 'Krishnahazar', 'Chevy', '前島麻由', 'Bastille', 'Rocco Minichiello', 'Naoki', 'Bruno Mars', 'RJ Pasin', ' RXPOSO99', 'Mc Gw', 'Phonk Killer', 'Dj Brunin XM & Mc Lullu', 'KKOMDA', 'OneRepublic', 'Miyu Tomita', 'MYTH&ROID', 'Kero Kero Benito']
let uploader = [`chipp`, 'chipp', 'chipp', 'Maxi', 'Monkey', 'Mahdi', 'Hell', 'Mahdi', 'Lunaria', 'Nisa', 'Arif', 'Arif', 'Mahdi', 'Wazi', 'Wazi', 'Wazi', 'Wazi', 'Wazi', 'Mahdi', 'Farel', 'Iswanto', 'Farel', 'Mahdi']
let accent = [`#978E75`, `#c264a6`, '#272571', '#715755', '#564E4B', '#846699', '#AD825D', '#72556B', '#6F4C4C', '#5C402B', '#48141B', '#84796A', '#F7D980', '#0B0B0B', '#764C7B', '#1C1C1B', '#232323', '#66747F', '#2AAA8A', '#00A36C', '#87CEEB', '#FFFFFF', '#FFC0CB']
